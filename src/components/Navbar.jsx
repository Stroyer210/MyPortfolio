...
const Navbar = () => {
  ...
  return (
      <div className='bg-black h-[100px] dark:bg-white text-gray-400 max-w-[1200px] mx-auto flex justify-between items-center'>
        ...
        <h1 className='text-3xl font-bold primary-color ml-4'>Sergio S. Ardila-Alvarado</h1>
        ...
        <div className={nav ? 'z-10 fixed h-full left-0 top-0 w-[60%] bg-[#202121] ease-in-out duration-500' : 'fixed left-[-100%]'}>
            <h1 className='text-3xl font-bold primary-color m-4'>Sergio S. Ardila-Alvarado</h1>
